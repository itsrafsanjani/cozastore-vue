<template>
  <div>
    <!-- <section class="home_banner_area mb-40">
      ...
      <!-- <carousel :items="1" :responsive="{0:{items:1,nav:false},600:{items:1,nav:false}}">
        <img class="img-fluid" src="https://placekitten.com/200/200/" alt="">
        <img class="img-fluid" src="https://placekitten.com/200/200/" alt="">
        <img class="img-fluid" src="https://placekitten.com/200/200/" alt="">
      </carousel> -->
    <Slider />
          ...
          <div class="col-lg-4 col-md-6">
            <div class="single-product">
              <div class="product-img">
                <img class="img-fluid w-100" src="static/img/product/feature-product/f-p-1.jpg" alt />
                <div class="p_icon">
                  <a href="#">
                    <i class="ti-eye"></i>
                  </a>
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="new_product">
              ...
              <div class="product-img">
                <img class="img-fluid" src="static/img/product/new-product/new-product1.png" alt />
              </div>
              <h4>$120.70</h4>
          ...
          <div class="col-lg-6 mt-5 mt-lg-0">
            <div class="row">
              <div class="col-lg-6 col-md-6">
                <div class="single-product">
                  <div class="product-img">
                    <img class="img-fluid w-100" src="static/img/product/new-product/n1.jpg" alt />
                    <div class="p_icon">
                      <a href="#">
                        <i class="ti-eye"></i>
                      </a>
              ...
              <div class="col-lg-6 col-md-6">
                <div class="single-product">
                  <div class="product-img">
                    <img class="img-fluid w-100" src="static/img/product/new-product/n2.jpg" alt />
                    <div class="p_icon">
                      <a href="#">
                        <i class="ti-eye"></i>
                      </a>
              ...
              <div class="col-lg-6 col-md-6">
                <div class="single-product">
                  <div class="product-img">
                    <img class="img-fluid w-100" src="static/img/product/new-product/n3.jpg" alt />
                    <div class="p_icon">
                      <a href="#">
                        <i class="ti-eye"></i>
                      </a>
              ...
              <div class="col-lg-6 col-md-6">
                <div class="single-product">
                  <div class="product-img">
                    <img class="img-fluid w-100" src="static/img/product/new-product/n4.jpg" alt />
                    <div class="p_icon">
                      <a href="#">
                        <i class="ti-eye"></i>
                      </a>
    ...
    allproducts: function () {
      this.$api.get('/products')
        .then((res) => {
          ...
          // this.products = JSON.parse(res.data.products.data.product_image)
          // console.log(JSON.parse(res.data.products.data.product_image))
